...
template<class T> void Maindata<T>:: report_appointment(BTree<T> btree_appointment)
{
    ...
    {
        bp_appointment.push_back(select(int iter->id, EQ));
    }
    /*把block的index输入relation里面得到id*/
...
template<class T> void Maindata<T>:: report_registered(BTree<T> btree_registered)
{
    ...
    {
        bp_registered.push_back(select(int iter->id, EQ));
    }
    /*把block的index输入relation里面得到id*/
...
week_report(1_btree_treated,1_btree_appointment,1_btree_registered);
week_report(2_btree_treated,2_btree_appointment,2_btree_registered);
week_report(3_btree_treated,3_btree_appointment,3_btree_registered);


month_report(1_btree_treated,1_btree_appointment,1_btree_registered,center1->withdraw_number);
month_report(2_btree_treated,2_btree_appointment,2_btree_registered,center2->withdraw_number);
month_report(3_btree_treated,3_btree_appointment,3_btree_registered,center3->withdraw_number);
